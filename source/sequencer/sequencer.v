...
// CLCT/RPC/RAT Pattern Injector
	...
	injector_mask_cfeb,
	injector_mask_rat,
	//injector_mask_rpc, // KSEDIT May 2022 RPC + MINI Rem
	inj_delay_rat,
	injector_go_cfeb,
	injector_go_rat,
	//injector_go_rpc,
...
// TMB LCT Match
  ...
  clct1_xky_xtmb,
	...
	tmb_alcte,
       ...
       tmb_hmt_match_win,
       hmt_nhits_sig_ff,
       // previous hmt partial implementation removed KSEDIT 19 May 2022
...
//	assign	header10_[14:0]		=	r_pretrig_counter[29:15];	// CLCT pre-trigger counter
	...
	//assign	header14_[14:0]		=	r_trig_counter[29:15];		// TMB trigger counter
        ...
        assign  header14_run3_[14]      =  r_hmt_nhits_sig_header[1]; //KSEDIT 19May2022 -> 17Jun2022 reverse
...
// CLCT Raw Hits Size
	...
	//assign	header19_[14]		=	mini_read_enable;			// Readout includes minicope data  // KSEDIT May 2022 RPC + MINI Rem
	assign	header19_[14]		=	0;			// Readout includes minicope data  
...
// CLCT Trigger Data
	...
	//assign	header27_[13]		=	perr_rpc_ff | perr_mini_ff;	// RPC  or Minicope RAM parity error, latched  // KSEDIT May 2022 RPC + MINI Rem
	assign	header27_[13]		= 0;
...
// ALCT Trigger Data
	...
	assign	header30_[4:0]		=	run3_daq_df ? r_hmt_nhits_sig_header[6:2] : r_alct_bxn[4:0];		// ALCT0/1 bxn //KSEDIT 19 may 2022
...
// RPC Configuration
	...
	*/  // KSEDIT May 2022 RPC + MINI Rem
	assign	header36_[1:0]		=	0;			// RPCs included in read out
	assign	header36_[3:2]		=	0;			// Number of RPCs in readout, 0,1,2, 0 if head-only event
	assign	header36_[4]		=	0;			// RPC readout enabled
	assign	header36_[9:5]		=	0;		// Number RPC FIFO time bins to read out
	assign	header36_[14:10]	=	0;		// Number RPC FIFO time bins before pretrigger
	assign	header36_[18:15]	=	0;							// DDU+DMB control flags
...
// Spare Frames
    ...
    //assign	header41_[2]		=	tmb_allow_match;			// Allow Match-only tmb-matching trigger //KSEDIT 19 May 2022
	//assign	header41_[3]		=	tmb_allow_alct_ro;			// Allow ALCT-only  tmb-matching readout only
	//assign	header41_[4]		=	tmb_allow_clct_ro;			// Allow CLCT-only  tmb-matching readout only
	//assign	header41_[5]		=	tmb_allow_match_ro;			// Allow Match-only tmb-matching readout only
...
//------------------------------------------------------------------------------------------------------------------
	...
	assign scp_ch_mux[159:104] = (scp_ch_overlay) ? scp_alct_rx[55:0] : scp_ch[159:104];	// Channels multiplexed  // KSEDIT May 2022 RPC + MINI Rem
...
//-------------------------------------------------------------------------------------------------------------------
	...
	wire header_sump=	
	(|r_mpc_reserved)	|
	r_wr_buf_avail;  // KSEDIT May 2022 RPC + MINI Rem
	//r_wr_buf_avail		|
	//rpc_tbinbxn[4]		|
	//mini_rdata[15];
