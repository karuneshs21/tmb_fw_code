...
// Pre-calculate fence address setback from pre-trigger address, take larger of cfeb or rpc pretrig tbins
	...
	//assign pretrig_setback  = (fifo_pretrig_cfeb >= fifo_pretrig_rpc) ? fifo_pretrig_cfeb : fifo_pretrig_rpc;   //KSEDIT May 2022 rem RPC + MINI
	assign pretrig_setback  = fifo_pretrig_cfeb;
