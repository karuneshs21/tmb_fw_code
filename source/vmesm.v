...
//
//-----------------------------------------------------------------------------------------------------------------
//	05/30/06 Initial port from jtagsm
//	06/01/06 Restructure header
//	06/05/06 Switch to embedded address format
//	07/06/06 Port to ISE 8.2iSP1
//	07/07/06 Mods to PROM address logic
//	07/10/06 Buffer adr and data outputs, align ds0 strobe
//	07/11/06 Status bits alignment
//	07/12/06 Abort if missing EC header-end marker
//	07/19/06 Mod wdcnt clear, add busy extend for jtagsm to avoid prom contention
//	07/20/06 Negate busy until vme_ready is asserted
//	07/21/06 Buffer busy_extend
//	07/25/06 Add persitence to vme signals to guarantee overlap with 10MHz vme clck
