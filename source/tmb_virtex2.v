...
// CLCT Pattern-finder results
 ...
 //wire [NHMTHITB-1:0] hmt_nhits_sig_ff; //for header DAQ
...
// VME debug register latches
	...
	wire	[MXBDATA-1:0]	deb_buf_pop_data;		// Queue pop  data at last pop
	 ...
	 // wire [3:0] tmb_hmt_match_win; //DAQ
      //wire  [MXHMTB-1:0] tmb_cathode_hmt; //DAQ
...
//KS remove rpc and miniscope 2022	.perr_mini_ff		(perr_mini_ff),					// Out	Mini RAM parity error, latched
	...
	.perr_ram_ff		(perr_ram_ff[41:0])				// Out	Mapped bad parity RAMs, 30 cfebs, 5 rpcs, 2 miniscope
	);
...
//KS remove rpc and miniscope 2022
	...
	//assign gp_io4	= alct_wr_fifo_tp;							// In	RPC_done KSEDIT May 2022 rem RPC
...
//KS remove rpc and miniscope 2022	.perr_mini_ff			(perr_mini_ff),						// In	Mini RAM parity error, latched
	.perr_ff				(perr_ff),							// In	Parity error summary,  latched
	.perr_ram_ff			(perr_ram_ff[41:0]),				// In	Mapped bad parity RAMs, 30 cfebs, 5 rpcs, 2 miniscope
...
//KS remove rpc and miniscope 2022
	...
	vme_sump | (|cfeb_sump) | inj_ram_sump   | clock_ctrl_sump;
